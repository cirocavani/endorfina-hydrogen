...
public class DataTotalHandler implements Handler<Message<JsonObject>>
{
	...
	private final DataTotalEngine engine = new DataTotalEngine();

	public DataTotalHandler(final EventBus eventBus, final String persistorAddress, final PersistorAdapter persistorAdapter)
	{
