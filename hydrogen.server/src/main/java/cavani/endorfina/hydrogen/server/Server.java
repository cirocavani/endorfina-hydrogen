...
import static cavani.endorfina.hydrogen.server.util.Constants.CONFIG_HOST;
import static cavani.endorfina.hydrogen.server.util.Constants.CONFIG_PORT;
import static cavani.endorfina.hydrogen.server.util.Constants.CONFIG_ROOT_FILE;
...
import static cavani.endorfina.hydrogen.server.util.Constants.CONFIG_WEB_ROOT;
...
import cavani.endorfina.hydrogen.server.service.HttpService;
import cavani.endorfina.hydrogen.server.service.HttpServiceHandler;
import cavani.endorfina.hydrogen.server.service.ServiceRegistry;
...
public class Server extends BusModBase
{
	...
	private static final String DEFAULT_WEB_ROOT = "hydrogen.server/src/main/webapp/";
